 ...
 * 
 */
package cn.iscas.xlab.xbotplayer.ros.rosbridge;

import java.lang.reflect.Field;

import cn.iscas.xlab.xbotplayer.ros.ROSClient;
import cn.iscas.xlab.xbotplayer.ros.Service;
import cn.iscas.xlab.xbotplayer.ros.message.Empty;
import cn.iscas.xlab.xbotplayer.ros.message.Message;
import cn.iscas.xlab.xbotplayer.ros.message.MessageType;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.MessageDetails;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.Nodes;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.Services;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.Topic;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.Topics;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.Type;
import cn.iscas.xlab.xbotplayer.ros.rosapi.message.TypeDef;
import cn.iscas.xlab.xbotplayer.ros.rosbridge.implementation.ROSBridgeWebSocketClient;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<cn.iscas.xlab.xbotplayer.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<cn.iscas.xlab.xbotplayer.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        cn.iscas.xlab.xbotplayer.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new cn.iscas.xlab.xbotplayer.ros.rosapi.message.Service(service)).type;
    }
